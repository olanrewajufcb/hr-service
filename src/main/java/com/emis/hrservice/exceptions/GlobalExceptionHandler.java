...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public Map<String, Object> handleSchoolAlreadyExists(ResourceAlreadyExistsException ex) {
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public Map<String, Object> handleSchoolNotFound(ResourceNotFoundException ex) {
        log.error("School not found: {}", ex.getMessage());
